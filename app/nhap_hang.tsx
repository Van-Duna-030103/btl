...
type Props = NativeStackScreenProps<RootStackParamList, 'NhapHang'>;

const NhapHangScreen: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.text}>Hiển thị nhập hàng</Text>
        <Icon name="add-shopping-cart" size={100} color="#00bfa5" />
      </View>
    </View>
  );
};
